$(document).ready(function() {
    ...
    async function reporte_diaria(datos){
        let funcion = "reporte_diaria";
        let data = await fetch('../controllers/ingresoDiariaController.php',{
            method: "POST",
            body: datos
    ...
    $.validator.setDefaults({
        submitHandler: function () {
            ...
            let datos = new FormData($('#form_reporte')[0]);
            let funcion = "reporte_diaria";
            datos.append('funcion',funcion);
            reporte_diaria(datos);
        }
    });
