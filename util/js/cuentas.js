$(document).ready(function(){
    ...
    $('#id_medios').select2({
        placeholder: 'Selecione medios de pago...',
        language: {
            noResult: function () {
    ...
    async function obtener_mediosPago(){
        let funcion = "obtener_mediosPago";
        ...
        try {
            ...
            $('#id_medios').html(template);
            $('#id_medios').val('').trigger('change');
            $('#medios').html(template);
            //$('#medios').val('').trigger('change');
        } catch (error) {
            console.error(error);
    ...
    async function obtener_cuentas(){
        let funcion = "obtener_cuentas";
            ...
            $('#cuentas').DataTable({
                ...
                {"render": function(data,type,datos,meta){
                    ...
                    if(datos.estado =='Pendiente'){
                        ...
                        monto="${datos.monto}"
                        medios="${datos.medios}"
                        class="editar_cuenta btn btn-circle btn-sm btn-outline-success ml-2 mb-2 mr-2" title="Editar cuenta" data-toggle="modal" data-target="#editar_cuenta"><i class="fas fa-pen-alt"></i></button>
                        </td>
                        `;
    ...
    async function registro_cuentas(datos){
        let data = await fetch('../controllers/CuentaController.php',{
            method: "POST",
        ...
        if(data.ok){
            ...
            if(respuesta.mensaje == 'success'){
                toastr.success('Se registro la cuenta','Exito!')
                obtener_cuentas();
    ...
    $.validator.setDefaults({
        submitHandler: function () {
            ...
            let funcion = "registro_cuentas";
            datos.append('funcion',funcion);
            registro_cuentas(datos);
        }
    });
    ...
    $(document).on('click','.editar_cuenta',(e)=>{
        ...
        $('#fecha_mod').val(fecha);
        $('#medios_mod').val(medios).trigger('change');
    });
