...
if($_POST['funcion'] == 'recuperar'){
  ...
  $email = $_POST['email'];
  $codigo = generar(10);
  $usuario-> remplazar($codigo,$dni,$email);
                  ...
                  <table cellpadding="0" cellspacing="0" width="600" class="w320">
                    <tr>
                      <td align="left" class="mobile-padding" style="padding:20px 20px 30px">
                        ...
                        <h1>DIGITALTEI SAC<br></h1>
                        <h3> Centro de recuperación de constraseñas</h3>

                        <br>
                        Hola, <strong>'.$dni.'.</strong>
                        <br>
                        Recibimos una solicitud de nueva contraseña para su cuenta en el sistema de servicio telecomunicaciones.
                        <br>
