<?php 
include_once('../model/ingresoAnual.php');
...
$ingresoAnual = new ingresoAnual();
if($_POST['funcion'] == 'reporte_anual'){
    ...
    ';
    $fecha_y = $_POST['fecha_y'];
    $ingresoAnual-> reporte_anual($fecha_y);
    $contador = 0;
    foreach ($ingresoAnual->objetos as $objeto) {
      $contador++;
